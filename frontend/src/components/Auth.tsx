...
import { SingupInput } from "@hrudayvv/common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Hruday Vinayak" onChange={(e)=>{
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }}/> : null}
                    <LabelledInput label="Username" placeholder="hrudayvv@gmail.com" onChange={(e)=>{
                        setPostInputs({
                            ...postInputs,
...
function LabelledInput({label, placeholder, onChange, type}: LabelledInputType){
    ...
    focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={placeholder} required />
</div>
}